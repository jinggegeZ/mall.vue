<template>
 <div class="register">
    ...
    <div class="r-box">
      <div class="r-box1">
        <van-cell-group>
          <van-field v-model="nickname" label="username" placeholder="请输入用户名" />
        </van-cell-group>
      </div>
      <div class="r-box1">
        <van-cell-group>
          <van-field v-model="password" label="passwrod" placeholder="请输入密码" />
        </van-cell-group>
      </div>
      <div class="r-box1">
        <van-cell-group>
...
<script>
 export default {
   ...
   methods: {
     ...
     register(){
       this.$api.register(nickname,password,verify).then
     }
   },
   mounted() {
