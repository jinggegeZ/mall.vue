 ...
 <div class="box">
    ...
    <div else class="box2">
      <div class="box3">
        ...
        <div class="box4">
          <div v-if="checkAll === true "><van-checkbox v-model="checkedAll" checked-color="#87CEFA"  shape="square" @click="checkedAll">取消全选</van-checkbox></div>
          <div v-else-if="checkAll === false "><van-checkbox v-model="checkedAll" checked-color="#87CEFA"  shape="square" @click="checkedAll">全选</van-checkbox></div>
          <div>
              <div class="box4font">
                <span>合计:</span>
