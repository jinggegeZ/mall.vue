<template>
  <div class="other_bei">
    <div class="locat"><van-icon name="arrow-left" color="#1989fa" class="back_last"  @click="backmine" />已完成</div>
    <van-tabs v-model="active" width="100%">
    <van-tab title="全部订单">
    <div class="order">
      <div class="order_a">
    ...
    <van-tab title="代发货">暂时没有内容哦，请稍后再来！</van-tab>
    <van-tab title="待支付">暂时没有内容哦，请稍后再来！</van-tab>
    <van-tab title="已发货">暂时没有内容哦，请稍后再来！</van-tab>
    <van-tab title="已完成">
    <div class="order">
      <div class="order_a">
        <div class="order_b" v-for="(item,index) in list" :key="index">
