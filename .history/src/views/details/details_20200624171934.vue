  ...
  <div class="box">
    ...
    <div class="bb1">
      <div class="bb5">
        ...
        <div class="bb6">
          <!-- 判断是否登录 -->
          <div v-if="nickname === ''" @click="get" >收藏<van-icon name="like" size="20" void-color="white" color="red" /></div>
          <!-- 是否已经收藏 -->
          <div v-else-if="iscollect === 0" @click="get">收藏<van-icon name="like" size="20" void-color="white" color="red" /></div>
          <div v-else>取消收藏<van-icon name="like" size="20" void-color="white" color="red" /></div>
        </div>
      </div>
    </div>
    <div class="bb2">
