    ...
    <div class="eva_a">
      <van-tabs >
        ...
        <van-tab title="已评价">
          <div class="eva_b">
            <div class="order_e" >
              <div class="order_f" v-for="item in arr" :key="item.id">
                <div class="order_g" v-for="item1 in item.goods" :key="item1.id">
                <div>
                  <img :src="item1.image" alt=""></div>
                  <div class="order_h">
                  <div>{{item1.name}}</div>
                  <van-button plain round type="default" size="small" class="shai" @click="gooldeva(item)">查看评价</van-button>
                </div>
                </div>
